...
- Metadata: `io.github.codexrodrigues:praxis-metadata-starter:8.0.0-rc.103`
...
- `io.github.codexrodrigues:praxis-config-starter` esta alinhado ao corte publicado `0.1.0-rc.72`; este quickstart acompanha o release candidate usado para validar os contratos atuais no host operacional de referencia e no rollout Render.
